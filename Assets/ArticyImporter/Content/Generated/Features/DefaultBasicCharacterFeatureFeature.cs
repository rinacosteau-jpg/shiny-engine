...
namespace Articy.World_Of_Red_Moon.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.World_Of_Red_Moon.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.World_Of_Red_Moon.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
            if ((mSpecies != null))
            {
        ...
        {
            Articy.World_Of_Red_Moon.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.World_Of_Red_Moon.Features.DefaultBasicCharacterFeatureFeature();
